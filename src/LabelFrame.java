...
public class LabelFrame extends JFrame {
    ...
    public LabelFrame() {
        ...
        Icon corazon = new ImageIcon(getClass().getResource("corazon1.png"));
        etiqueta2 = new

                JLabel("Etiqueta con texto e icono", corazon, SwingConstants.LEFT);
        ...
        etiqueta3.setIcon(corazon); // agrega icono a JLabel
