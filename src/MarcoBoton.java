...
public class MarcoBoton extends JFrame {
    ...
    public MarcoBoton() {
        ...
        Icon corazon1 = new ImageIcon(getClass().getResource("corazon1.png"));
        Icon icon2 = new ImageIcon(getClass().getResource("icon2.png"));
        botonJButtonElegante = new JButton("Boton elegante", corazon1); // establece la imagen
        botonJButtonElegante.setRolloverIcon(icon2); // establece la imagen de sustitución
